...
public class TVListings_CurrentScrollForward_CA_Test extends TestBase {
	
	static String zipcode = "90210";
	static String timezone = "US/Pacific";
	static SoftAssert softAssert = new SoftAssert();
	
	@Test
	public void VerifyCurrentScrollForwardCAPage() throws InterruptedException, IOException
	{
	    ...
	    {
	    	if ("Time Warner Cable City of Los Angeles (Eagle Rock)".equals(option.getText()))
    			option.click();
	            Thread.sleep(2000);
	    }
		...
		String selectedshortdate = curdatehr.PacificXpathPhrase().getText();
	    selectedshortdate = selectedshortdate.replaceAll("[\n\r]", "");
	    String weekday = CurrentDateTime.pacificweekday();
	    String shortdate = weekday + CurrentDateTime.pacificday();
	    ...
	    {
		    weekday = CurrentDateTime.pacificweekday();
	    ...
	    {
		    weekday = CurrentDateTime.pacificweekday();
		    shortdate = weekday + CurrentDateTime.pacificday();
